  ...
  <div class="main-content">
    <div class="container-fluid">
      <div class="row">
        ...
        <div class="col-md-9">
          <div class="h2 pt-3 pb-3 px-5 center" id="adm-title">Generate Department wise Report</div>
          <form id="addform" autocomplete="off">
            ...
            <div class="row pt-3" style="margin-left:25%;">
              ...
              <div class="col-sm-6 col-md-6 form-group">
                <select class="form-control" id="depart_name">
                  <option value="">------ Enter Department Name --------</option>
